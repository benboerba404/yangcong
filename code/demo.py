# -*- coding: utf-8 -*-
"""
Created on Thu Feb 10 16:45:30 2022
...
#获得链接
##连接数据库                        
conn = connect(host='10.17.2.45', port=10010, auth_mechanism='PLAIN', database='crm',user='tanchen', password='Yangcong345') #10010是sparksql，10000是hive
#获取与数据库交互的对象
...
cur.execute(sql1)
print('tmp.tanchen_v2_aws_crm_order_amount!')
conn.close()
